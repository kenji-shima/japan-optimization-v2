...
const command = `mbx github-app register -g mbx-publisher --repo ${publicURL}`;
const login = `mbx env && mbx npm login`
const register = `npx @mapbox/publisher register ${publicURL}`
